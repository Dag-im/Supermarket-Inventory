import { Edit2, Lock, Plus, Search, Shield, Trash2, User } from 'lucide-react';
    ...
    return (
      <div className="h-[70vh] flex flex-col items-center justify-center text-center p-12">
        <motion.div
          ...
          className="w-24 h-24 bg-rose-50 text-rose-600 rounded-4xl flex items-center justify-center mb-8 shadow-xl shadow-rose-500/10"
        >
          <Shield className="w-12 h-12" />
        </motion.div>
        <h2 className="text-3xl font-black text-ink-main tracking-tighter">
          Access Restricted
        </h2>
        <p className="text-ink-muted text-sm mt-3 max-w-md font-medium">
          Only the system owner has permission to manage users and modify roles.
        </p>
    ...
    <div className="space-y-8 max-w-400 mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-ink-muted text-sm mt-1 font-medium">
            Control system access and assign administrative roles.
          </p>
        </div>
        <button
      ...
      <div className="card-vibrant overflow-hidden p-0 border-none shadow-indigo-500/10">
        <div className="p-8 bg-indigo-50/30 flex items-center justify-between border-b border-indigo-50">
          ...
          <span className="text-[11px] font-black text-brand-primary uppercase tracking-[0.2em] bg-white px-4 py-2 rounded-xl border border-indigo-50 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="p-10 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value={UserRole.DISPATCH_MANAGER}>
                      Dispatch Manager
                    </option>
                    <option value={UserRole.STORE_MANAGER}>
                      Store Manager
                    </option>
