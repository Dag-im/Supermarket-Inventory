        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-indigo-50/30">
              <th className="data-table-header rounded-tl-3xl">
                Product Details
              </th>
                  ...
                  >
                    ...
                    <td className="data-table-cell">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-ink-muted font-black">
                          / {product.minStockStore}
                        </span>
                      </div>
                    </td>
                    <td className="data-table-cell">
                          ...
                          >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                              <div className="space-y-4">
                                <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-brand-primary">
                                  Active Batches
                                </h4>
                                <div className="space-y-3">
                                  {batches
                                    ...
                                    .map((batch) => (
                                      <div
                                        key={batch.id}
                                        className="flex items-center justify-between p-4 bg-white rounded-2xl border-2 border-indigo-50 shadow-sm"
                                      >
                                        <div className="flex items-center gap-4">
                                          <div
                                            className={cn(
                                              'w-3 h-3 rounded-full shadow-lg',
                                              batch.location === 'STORE'
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="p-6 bg-brand-primary rounded-3xl text-white shadow-xl shadow-indigo-500/30 relative overflow-hidden group">
                                  ...
                                  <div className="flex items-center justify-between mb-6 relative z-10">
                                    ...
                                    <span className="px-3 py-1 bg-white/20 text-white rounded-full text-[9px] font-black uppercase">
                                      Live
                                    </span>
                                  </div>
                                  <div className="grid grid-cols-2 gap-8 relative z-10">
                                    ...
                                    <div>
                                      <p className="text-3xl font-black tracking-tighter text-pink-300">
                                        85
                                      </p>
                                      <p className="text-[10px] text-white/50 uppercase font-black tracking-widest mt-1">
                                        7D Projection
              ...
              <form onSubmit={handleBatchSubmit} className="p-10 space-y-6">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewBatch({ ...newBatch, productId: e.target.value })
                    }
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewBatch({
                          ...newBatch,
                          location: e.target.value as 'STORE' | 'DISPATCH',
                        })
                      }
                      className="w-full px-5 py-3 bg-indigo-50/30 border-2 border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-brand-primary transition-all outline-none"
                    >
                ...
                <button
                  type="submit"
                  className="w-full py-5 bg-brand-primary text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/30"
                >
                  Receive Stock
                </button>
              </form>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewTransfer({
                          ...newTransfer,
                          fromLocation: e.target.value as 'STORE' | 'DISPATCH',
                        })
                      }
                      className="w-full px-5 py-3 bg-indigo-50/30 border-2 border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-brand-primary transition-all outline-none"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewTransfer({
                          ...newTransfer,
                          toLocation: e.target.value as 'STORE' | 'DISPATCH',
                        })
                      }
                      className="w-full px-5 py-3 bg-indigo-50/30 border-2 border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-brand-primary transition-all outline-none"
                    >
