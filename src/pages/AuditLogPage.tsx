    ...
    <div className="space-y-8 max-w-400 mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-ink-muted text-sm mt-1 font-medium">
            Immutable record of all system operations and security events.
          </p>
        </div>
      ...
      <div className="card-vibrant overflow-hidden p-0 border-none shadow-indigo-500/10">
        <div className="p-8 bg-indigo-50/30 flex items-center justify-between border-b border-indigo-50">
          ...
          <span className="text-[10px] font-black text-brand-primary uppercase tracking-widest bg-white px-4 py-2 rounded-xl border border-indigo-50 shadow-sm">
            Latest 50 entries
          </span>
        </div>
        <div className="divide-y divide-indigo-50">
          {auditLogs.map((log) => (
            <div
              key={log.id}
              className="p-8 flex items-center justify-between hover:bg-indigo-50/30 transition-colors group"
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="font-black text-base tracking-tight text-ink-main">
                    {log.details}
                  </p>
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] text-ink-muted/40 mt-2 font-black font-mono">
          ...
          {auditLogs.length === 0 && (
            <div className="p-32 text-center opacity-40">
              ...
              <p className="text-xs font-black uppercase tracking-[0.4em] text-ink-muted">
