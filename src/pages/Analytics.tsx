    ...
    <div className="space-y-8 max-w-400 mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-ink-muted text-sm mt-1 font-medium">
            Advanced inventory performance and growth metrics.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          {
            name: 'Net Profit',
            value: `${totalProfit.toLocaleString()} ETB`,
            icon: TrendingUp,
            color: 'text-pink-600',
            bg: 'bg-pink-50',
          ...
          <div
            key={stat.name}
            className="card-vibrant p-6 border-2 border-transparent hover:border-indigo-50 transition-all group"
          >
            ...
            <p className="text-2xl font-black tracking-tighter text-ink-main">
              {stat.value}
            </p>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="card-vibrant p-8">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-brand-primary">
              Revenue vs Target
            </h2>
        ...
        <div className="card-vibrant p-8">
          <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-brand-primary mb-10">
      ...
      <div className="card-vibrant bg-brand-primary text-brand-primary p-10 border-none shadow-2xl shadow-indigo-500/40 relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gray-50/10 rounded-full -mr-32 -mt-32 blur-3xl group-hover:scale-125 transition-transform duration-700" />
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-brand-primary/10 rounded-full -ml-32 -mb-32 blur-3xl group-hover:scale-125 transition-transform duration-700" />
        ...
        <div className="flex items-center justify-between mb-10 relative z-10">
          <div>
            ...
            <p className="text-white/60 text-[11px] font-black uppercase tracking-[0.3em] mt-2">
              Revenue generation by product unit
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 relative z-10">
          {products.slice(0, 6).map((product, i) => (
            <div
              key={product.id}
              className="p-6 bg-gray-200/10 rounded-3xl border border-gray-50/10 hover:bg-gray-200/20 transition-all group/item backdrop-blur-sm"
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="px-3 py-1 bg-emerald-500/10 text-emerald-500 rounded-full text-[9px] font-black uppercase tracking-widest border border-emerald-500/50">
                  Top 10%
                </span>
              </div>
              ...
              <p className="text-[10px] text-rose-800/50 uppercase font-black tracking-widest mt-1">
                {product.category}
              </p>
              <div className="mt-6 pt-6 border-t border-white/10 flex items-end justify-between">
                <div>
                  <p className="text-xl font-black text-brand-secondary">
                    {(Math.random() * 50000 + 10000).toLocaleString()} ETB
                  </p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-[9px] text-brand-accent/70 uppercase font-black tracking-widest mt-1">
                    Growth
                  </p>
                </div>
              </div>
