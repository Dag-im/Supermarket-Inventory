  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-black tracking-tighter text-ink-main">Partners</h1>
          <p className="text-ink-muted text-sm mt-1 font-medium">Manage vendor relationships and supply chains.</p>
        </div>
        <button 
        ...
        {filteredSuppliers.map((supplier) => (
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-lg font-black text-ink-main tracking-tight">{supplier.name}</h3>
              <p className="text-[11px] text-brand-primary font-black uppercase tracking-[0.2em] mt-1">{supplier.contactPerson}</p>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-center gap-4 text-ink-muted group/info">
                  ...
                  <span className="text-xs font-bold truncate">{supplier.address}</span>
                </div>
              </div>

              <div className="mt-8 pt-6 border-t border-indigo-50 flex items-center justify-between">
                <span className="badge-vibrant bg-emerald-50 text-emerald-600 border-emerald-100">Active Partner</span>
          ...
          <div className="fixed inset-0 bg-indigo-900/20 backdrop-blur-md z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="bg-brand-primary p-10 text-white relative overflow-hidden">
                ...
                <h2 className="text-3xl font-black tracking-tighter relative z-10">Register Partner</h2>
                <p className="text-white/60 text-[11px] font-black uppercase tracking-[0.3em] mt-2 relative z-10">Vendor Information Management</p>
              </div>
              <form onSubmit={handleSubmit} className="p-10 space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[11px] font-black uppercase tracking-widest text-ink-muted ml-1">Company Name</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] font-black uppercase tracking-widest text-ink-muted ml-1">Contact Person</label>
                    <input 
                      type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-black uppercase tracking-widest text-ink-muted ml-1">Phone Number</label>
                  <input 
                    type="tel" 
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-black uppercase tracking-widest text-ink-muted ml-1">Business Address</label>
                  <textarea 
                    value={newSupplier.address}
                    onChange={(e) => setNewSupplier({...newSupplier, address: e.target.value})}
                    className="w-full px-5 py-3 bg-indigo-50/30 border-2 border-transparent rounded-2xl text-sm font-bold focus:bg-white focus:border-brand-primary transition-all outline-none min-h-[100px] resize-none"
                    required
                  />
                </div>
